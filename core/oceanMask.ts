 ...
 * `simplex-noise` so a GLSL simplex3D can reproduce the exact CPU elevation
 * field — used in `shaders/glsl/lib/oceanMask.glsl` to gate per-fragment
 * effects (cracks, lava) to non-ocean regions.
 */
