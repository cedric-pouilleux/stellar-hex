...
```ts
import { STAR_TILE_REF } from '@cedric-pouilleux/stellar-hex/core'
...
```ts
import { resolveStarData } from '@cedric-pouilleux/stellar-hex/sim'
...
```ts
import { toStarParams } from '@cedric-pouilleux/stellar-hex/sim'
...
```ts
import { SPECTRAL_TABLE } from '@cedric-pouilleux/stellar-hex/sim'
...
```ts
import { buildStarPalette } from '@cedric-pouilleux/stellar-hex/core'
...
```ts
import { godRaysFromStar } from '@cedric-pouilleux/stellar-hex/core'
