...
```ts
import { buildLayeredPrismGeometry } from '@cedric-pouilleux/stellexjs/core'
...
```ts
import { buildLayeredMergedGeometry } from '@cedric-pouilleux/stellexjs/core'
...
```ts
import { buildAtmoBoardMesh } from '@cedric-pouilleux/stellexjs/core'
...
```ts
import { bodyOuterRadius } from '@cedric-pouilleux/stellexjs/core'
...
```ts
import { findSceneRoot } from '@cedric-pouilleux/stellexjs/core'
