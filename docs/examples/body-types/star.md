...
Corps en fusion nucléaire avec granulation convective animée, corona et pulsation. La couleur de surface est entièrement dérivée de la température en kelvins via la loi de Planck (blackbody).
...
| `spectralType` | `'O'\|'B'\|'A'\|'F'\|'G'\|'K'\|'M'` | Classe spectrale — dérive température et couleur |
