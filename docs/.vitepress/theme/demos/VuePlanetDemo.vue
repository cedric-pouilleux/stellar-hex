...
import type { WarmupProgress } from '@cedric-pouilleux/stellar-hex/core'
...
function onProgress(info: WarmupProgress) {
  ...
  <div class="vue-demo-wrap">
    <TresCanvas class="vue-demo" :clear-color="'#08080f'">
      ...
      <Body
        ...
        :preview-mode="true"
      />
      <BodyWarmup :body="body" @progress="onProgress" @ready="onReady" />
    </TresCanvas>
